...
這些詞彙專屬於EPUB 3，當在使用時首字大寫（原文版本）。

每一章節中術語只在第一次出現時會連結到其定義。
...
一份EPUB內容文件就是核心媒體類別資源，所以可以被包含在EPUB出版品而不需提供任何回退。
...
非核心媒體類別資源的出版品資源。外部資源需要提供如外部資源中所定義的回退。
